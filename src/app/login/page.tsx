  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      >
        ...
        <p className="text-sm text-text-primary font-medium">Design new landing</p>
        <div className="mt-2 flex gap-1">
          <span className="text-[10px] px-1.5 py-0.5 rounded bg-accent/20 text-accent">UI</span>
        </div>
      </div>
      ...
      >
        ...
        <p className="text-sm text-text-primary font-medium">Write documentation</p>
        <p className="text-xs text-text-dim mt-1 line-clamp-2">Add examples and API reference</p>
      </div>
  ...
  return (
    <div className="hidden lg:flex relative flex-col justify-center items-center flex-1 bg-background-elevated p-12 overflow-hidden">
      ...
      <div className="relative z-10 max-w-md text-center">
        ...
        <div className="flex items-center justify-center gap-3 mb-8 animate-fade-in">
          <div className="relative">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-accent to-accent-hover flex items-center justify-center shadow-lg">
              <svg className="w-7 h-7 text-background" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
        ...
        {/* Tagline */}
        <h1 className="text-4xl md:text-5xl font-semibold text-text-primary mb-4 animate-fade-in-up" style={{ animationDelay: '100ms' }}>
          Ship ideas,<br />
          <span className="font-display italic text-accent">not spreadsheets</span>
        </h1>
      ...
      <div className="flex-1 lg:max-w-xl flex flex-col justify-center px-6 py-12 lg:px-16">
        ...
        <div className="lg:hidden flex items-center justify-center gap-3 mb-10 animate-fade-in">
          <div className="relative">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-accent to-accent-hover flex items-center justify-center">
              <svg className="w-6 h-6 text-background" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                <path strokeLinecap="round" strokeLinejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z" />
              </svg>
            </div>
        ...
        <div className="lg:hidden text-center mb-10 animate-fade-in-up">
          <h2 className="text-2xl font-semibold text-text-primary mb-2">
            Ship ideas, <span className="font-display italic text-accent">not spreadsheets</span>
          </h2>
          <p className="text-sm text-text-muted">Project management for creatives</p>
        </div>
        ...
        <div className="w-full max-w-sm mx-auto lg:mx-0">
          <div className="animate-fade-in-up" style={{ animationDelay: '100ms' }}>
            ...
            <p className="text-text-muted mb-8">Sign in to continue to your projects</p>
          </div>
          ...
          <p className="mt-8 text-center text-sm text-text-muted animate-fade-in-up" style={{ animationDelay: '300ms' }}>
