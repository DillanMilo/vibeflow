    ...
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      >
        ...
        <div className="mt-2 flex gap-1">
          <span className="text-[10px] px-1.5 py-0.5 rounded bg-success/20 text-success">Done</span>
        </div>
      </div>
  ...
  return (
    <div className="hidden lg:flex relative flex-col justify-center items-center flex-1 bg-background-elevated p-12 overflow-hidden">
      ...
      <div className="relative z-10 max-w-md text-center">
        ...
        <p className="text-lg text-text-secondary mb-12 animate-fade-in-up" style={{ animationDelay: '200ms' }}>
          Join thousands of creators who ship faster with Vibeflow.
        </p>

        {/* Benefits list */}
        <div className="space-y-4 text-left animate-fade-in-up" style={{ animationDelay: '300ms' }}>
      ...
      <div className="flex-1 lg:max-w-xl flex flex-col justify-center px-6 py-12 lg:px-16">
        ...
        <div className="lg:hidden text-center mb-10 animate-fade-in-up">
          <h2 className="text-2xl font-semibold text-text-primary mb-2">
            Your ideas, <span className="font-display italic text-accent">in flow</span>
          </h2>
          <p className="text-sm text-text-muted">Join creators who ship faster</p>
        </div>
        ...
        <div className="w-full max-w-sm mx-auto lg:mx-0">
          <div className="animate-fade-in-up" style={{ animationDelay: '100ms' }}>
            ...
            <p className="text-text-muted mb-8">Start shipping ideas in minutes</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <p className="text-xs text-text-dim text-center animate-fade-in-up" style={{ animationDelay: '350ms' }}>
              By signing up, you agree to our terms of service and privacy policy.
            </p>
          </form>

          <p className="mt-8 text-center text-sm text-text-muted animate-fade-in-up" style={{ animationDelay: '400ms' }}>
